...
export default function StockInfo({ isOpen, onClose, ticker }) {
    const handleBuyClick = () => {
        // Updated toast call without POSITION object reference
        toast.warning("Whoa! This stock has not been performing as well recently. HINT: Try looking up articles and earning information.", {
            position: "bottom-right", // Directly using the string for position
                            ...
                            <div className="flex-1 flex flex-col justify-between text-[17px]">
                                ...
                                <div className="flex flex-row gap-6">
                                    <button
                                        ...
                                        className="text-black text-xl font-semibold bg-green-200 p-4 rounded-lg text-center flex-1 h-full flex items-center justify-center"
                                    >
                                        BUY
                                    </button>
