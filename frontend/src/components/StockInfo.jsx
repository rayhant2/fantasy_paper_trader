        ...
        <DialogPanel className="w-full max-w-4xl h-full rounded-2xl bg-white p-10 shadow-xl flex flex-col">
          ...
          <div className="flex-1 flex flex-row gap-6">
              ...
              <div className="flex flex-row gap-10 justify-center items-center h-full">
                ...
                <div className="flex flex-col gap-2 flex-1 items-start">
                  <div className="text-black p-4 rounded-lg flex items-center justify-center h-full">
                    <div className="font-bold mr-3">HI: </div>
                    <div className="text-[#228B22]">$230492</div>
                  </div>
                  <div className="text-black p-4 rounded-lg flex items-center justify-center h-full">
                    <div className="font-bold mr-3">OPEN: </div>
                    <div className="text-blue-700">$45334</div>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-2 flex-1 items-start">
                  <div className="text-black p-4 rounded-lg flex items-center justify-center h-full">
                    <div className="font-bold mr-3">LO: </div>
                    <div className="text-[#990000]">$230</div>
                  </div>

                  <div className="text-black p-4 rounded-lg flex items-center justify-center h-full">
                    <div className="font-bold mr-3">CLOSE: </div>
                    <div className="text-blue-900">$34509</div>
                  </div>
                </div>
              </div>
            ...
            <div className="flex-1 bg-yellow-100 rounded-xl p-4 flex items-center justify-center h-full">
              <span className="text-gray-600 text-xl">Graph Here</span>
            </div>
          </div>
